...
# /home1/surfzjy/data/ccpd_0
# /home1/surfzjy/data/taxi1200_segall/

tf.app.flags.DEFINE_string('training_data_path', '/home1/surfzjy/data/taxi1200_segall/',
                           'training dataset to use')
tf.app.flags.DEFINE_integer('max_image_large_side', 2560,
                            'max image size of training')
tf.app.flags.DEFINE_integer('max_text_size', 1600,
...
def shrink_poly(poly, r):
    ...
    '''
    # shrink ratio /// ScoreMap收缩比例，原来的代码中是0.3
    R = 0.05
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                # tmp = geo_map[::4, ::4, :].astype(np.float32).flatten()
                # for i in tmp:
                    # if i>0:
                        # print(i)
