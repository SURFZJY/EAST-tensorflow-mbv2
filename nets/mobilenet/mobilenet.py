...
def mobilenet_base(  # pylint: disable=invalid-name
  ...
  with _scope_all(scope, default_scope='Mobilenet'), \
    ...
    # 2019.4.24 add endpoints for east inference

    end_points['pool2'] = end_points['layer_5/expansion_output']  # 56*56*192
    end_points['pool3'] = end_points['layer_8/expansion_output']  # 28*28*288
    end_points['pool4'] = end_points['layer_15/expansion_output']  # 14*14*816
    end_points['pool5'] = net  # 7*7*1344
...
def mobilenet(inputs,
              ...
              reuse=None,
              scope='Mobilenet',
              base_only=True,  # 2019.4.24 change for east, cancel pool op 
              **mobilenet_args):
